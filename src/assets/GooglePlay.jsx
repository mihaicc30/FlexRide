...
export default function GooglePlay() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 135 40"  className="h-[5vh]">
      ...
      <path
        fill="#fff"
        d="M12.5 7.6 32 18.7c.6.4 1 .8 1 1.3 0-.5-.3-1-1-1.4l-19.5-11c-1.4-.9-2.5-.3-2.5 1.3V9c0-1.5 1.1-2.2 2.5-1.4z"
        opacity={0.25}
      />
    </svg>
  );
